...
#http://www.youtube.com/watch?v=GUPNpQaJiLI

from gimpfu import *

def inkwell( img, draw ):
	...
	pdb.gimp_item_set_name(lg,"Inkwell Effect")
	...
	pdb.gimp_item_set_name(drawCopy,"inkwellBG")
	pdb.gimp_desaturate_full(drawCopy,0)

	#adjust curves colors
	pdb.gimp_curves_spline(drawCopy, 0, 10, (0,0, 13,0, 83,125, 178,219, 255,255) )

	#adjust brightness contrast
	pdb.gimp_brightness_contrast(drawCopy,-15,15)
...
register( "gimp_instagram_inkwell",
  "Add Instagram inkwell effect",
  "Add Instagram inkwell effect",
  "Marco Crippa",
  "(©) 2013 Marco Crippa",
  "2013-01-08",
  "<Image>/Filters/Instagram/Inkwell",
  'RGB*',
  [],
  '',
  inkwell)
