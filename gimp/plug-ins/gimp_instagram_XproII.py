...
#http://www.youtube.com/watch?v=X_DKcED2ZuI
...
def XproII( img, draw ):
	...
	pdb.gimp_item_set_name(lg,"XProII Effect")

	#copy image
	drawCopy=pdb.gimp_layer_new_from_drawable(draw,img)
	pdb.gimp_image_insert_layer(img, drawCopy, lg, 0)
	pdb.gimp_item_set_name(drawCopy,"XproIIBG")
	#adjust curves colors
	pdb.gimp_curves_spline(drawCopy, 0, 10, (0,0, 62,45, 128,128, 187,204, 255,255) )
	pdb.gimp_curves_spline(drawCopy, 1, 12, (0,0, 54,30, 105,86, 148,144, 210,209, 255,255) )
	pdb.gimp_curves_spline(drawCopy, 2, 8, (0,0, 87,61, 231,231, 255,255) )
	pdb.gimp_curves_spline(drawCopy, 3, 8, (0,25, 76,82, 163,149, 255,180) )
...
register( "gimp_instagram_XproII",
  "Add Instagram X-Pro II effect",
  "Add Instagram X-Pro II effect",
  "Marco Crippa",
  "(©) 2013 Marco Crippa",
  "2013-01-08",
  "<Image>/Filters/Instagram/X-Pro II",
  'RGB*',
  [],
  '',
  XproII)
