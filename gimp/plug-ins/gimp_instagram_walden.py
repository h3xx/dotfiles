...
#http://thecreativepixel.com/tutorial-tuesday/
...
def walden( img, draw ):
	...
	pdb.gimp_curves_spline(drawCopy, 0, 4, (12,0, 255,255) )
	pdb.gimp_curves_spline(drawCopy, 1, 4, (10,0, 247,255) )
	pdb.gimp_curves_spline(drawCopy, 3, 4, (0,38, 255,203) )

	#adjust levels colors
	pdb.gimp_levels(drawCopy, 0, 0, 235, 1.17, 55, 255)

	#adjust curves colors
	pdb.gimp_curves_spline(drawCopy, 0, 6, (41,0, 125,124, 255,255) )

	#set color gradient vignette layer
	vign = pdb.gimp_layer_new(img,w,h,1,"waldenVignette",100.0,0)
	pdb.gimp_image_insert_layer(img, vign, lg, 0)
	pdb.gimp_image_set_active_layer(img,vign)
	delta=(w/100)*30
	pdb.gimp_context_set_foreground((0,0,0))
	pdb.gimp_edit_blend(vign,2,0,2,100,0,0,1,0,4,2,1, 0,0,w*2,h*2)
	pdb.gimp_layer_set_mode(vign,19)
...
register( "gimp_instagram_walden",
  "Add Instagram walden effect",
  "Add Instagram walden effect",
  "Marco Crippa",
  "(©) 2013 Marco Crippa",
  "2013-01-08",
  "<Image>/Filters/Instagram/Walden",
  'RGB*',
  [],
  '',
  walden)
