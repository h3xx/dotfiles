...
aug keycommands
	...
	au FileType		alsaconf,coffee,conf,config,cvsrc,gtkrc,mplayerconf,muttrc,perl,php,procmail,python,readline,remind,resolv,screen,sh,squid,sshconfig,sudoers,yaml
